...
@Deprecated("Use DatabaseAccess via `space.maxus.macrocosm.database` instead", ReplaceWith("space.maxus.macrocosm.database"))
object Database {
    @org.jetbrains.annotations.ApiStatus.ScheduledForRemoval
    @Deprecated("Use DatabaseAccess via `space.maxus.macrocosm.database` instead", ReplaceWith("space.maxus.macrocosm.database.connect()"))
    fun connect() {
    ...
    @org.jetbrains.annotations.ApiStatus.ScheduledForRemoval
    @Deprecated("Use DatabaseAccess via `space.maxus.macrocosm.database` instead", ReplaceWith("space.maxus.macrocosm.database.readAllPlayers()"))
    ...
    object Limited {
        @org.jetbrains.annotations.ApiStatus.ScheduledForRemoval
        @Deprecated("Use DatabaseAccess via `space.maxus.macrocosm.database` instead", ReplaceWith("space.maxus.macrocosm.database.incrementLimitedEdition(item)"))
