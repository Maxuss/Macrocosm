...
data class DefaultPetParticle(private val particle: Particle, private val amount: Int = 1): PetParticles {
...
data class BlockPetParticle(private val block: Material, private val amount: Int = 1): PetParticles {
...
data class DustPetParticle(private val color: Int, private val size: Float = 1f, private val amount: Int = 1): PetParticles {
