...
object WardenHelmetAbility : AbilityBase(
    AbilityType.PASSIVE,
    "Brute Force",
    "Lose all of your speed over <white>200<gray> but gain <red>+10% ${Statistic.STRENGTH.display}<gray> for each <green>50 Speed<gray> lost."
) {
