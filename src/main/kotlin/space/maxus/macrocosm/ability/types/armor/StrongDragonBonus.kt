...
object StrongDragonBonus: FullSetBonus("Strong Blood", "Buffs <blue>Aspect of the End<gray> and adds <red>+100 ${Statistic.DAMAGE.display}<gray> and <red>+75 ${Statistic.STRENGTH.display}<gray> to it.") {
