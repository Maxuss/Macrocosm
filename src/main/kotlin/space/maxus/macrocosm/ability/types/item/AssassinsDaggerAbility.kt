...
object AssassinsDaggerAbility : AbilityBase(
    AbilityType.PASSIVE,
    "Assassin's Anticipation",
    "Attack on the enemies' backs to deal<br>${Fmt.SUPER_CRIT} damage!"
) {
    override fun registerListeners() {
        listen<PlayerDealDamageEvent> { e ->
            ...
            val playerYaw =
                e.player.paper?.location?.yaw ?: report("Player in DealDamageEvent was null!") { return@listen }
