...
object GhoulBusterAbility : FullSetBonus(
    "Ghoul Buster",
    "You deal <red>200% ${Statistic.DAMAGE.display}<gray> to <blue>Zombies<gray> but only <red>1% ${Statistic.DAMAGE.display}<gray> to other mobs.",
    true
) {
