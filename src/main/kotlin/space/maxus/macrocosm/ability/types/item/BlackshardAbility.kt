...
object BlackshardAbility: AbilityBase(AbilityType.PASSIVE, "Call from the Grave", "Deal <red>200% ${Statistic.DAMAGE.display}<gray> against <blue>non-undead<gray> mobs.<br>Heal for <red>0.1%<gray> of your maximum ${Statistic.HEALTH.display}<gray> per hit on <blue>undead<gray> mob.") {
