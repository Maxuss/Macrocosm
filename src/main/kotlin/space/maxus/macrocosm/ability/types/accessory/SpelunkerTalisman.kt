...
class SpelunkerTalisman(applicable: String, private val amount: Int): AccessoryAbility(applicable, "Increases your ${Statistic.MINING_FORTUNE.display} by <gold>+$amount<gray> when mining rare minerals.") {
    private val rareMinerals = arrayOf("blackstone_adamantine_ore", "deepslate_adamantine_ore", "titanium_ore", "geyserite_ore", "lumium_ore").map(Identifier::macro)
