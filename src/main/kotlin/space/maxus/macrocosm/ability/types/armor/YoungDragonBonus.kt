...
object YoungDragonBonus: FullSetBonus("Young Blood", "Gain <white>+100 ${Statistic.SPEED}<gray> while above <green>50%<gray> Health. Boosts your <green>Speed Cap<gray> by <yellow>100<gray>.") {
