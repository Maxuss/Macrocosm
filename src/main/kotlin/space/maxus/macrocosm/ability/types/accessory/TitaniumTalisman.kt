...
class TitaniumTalisman(applicable: String, private val amount: Int): AccessoryAbility(applicable, "Increases your ${Statistic.MINING_FORTUNE.display} by <gold>+$amount<gray> when below <blue>Y 30<gray>.") {
