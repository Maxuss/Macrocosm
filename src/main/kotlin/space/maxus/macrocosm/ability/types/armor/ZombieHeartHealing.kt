...
class ZombieHeartHealing(name: String, val amount: Float): AbilityBase(AbilityType.PASSIVE, name, "Heal for <red>${Formatting.stats(amount.toBigDecimal())} ${Statistic.HEALTH}<gray> each time you get hit.") {
