...
object FireTalisman: AccessoryAbility("fire_talisman", "Decreases all ${Statistic.DAMAGE.display}<gray> taken from <gold>Fire<gray> and <gold>Lava<gray> by <red>20%<gray>.") {
