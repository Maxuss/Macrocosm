...
class SimpleReforge(override val name: String, override val applicable: List<ItemType>, private val baseStats: Statistics, private val multiplier: Float = 1f) : Reforge {
